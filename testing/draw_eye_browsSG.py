...
from get_eye_brow import EyeBrows
...
class Visualizer:
    ...
    def __init__(self, args):
        ...
        self.eye_brow_right_obj = EyeBrows(r'Eyebrows\eyeBrowLeft.obj')
    ...
    def draw_eye_brows(self, frame, roi, landmarks, head_pose):
        ...
        p2, p1 = int(center_r[0]-cols/2),int(center_r[1]-rows/3)#0, 250
        ...
        p2, p1 = int(center_l[0]-cols/2),int(center_l[1]-rows/3)#0, 250
